...
Malarkdowney sits in the middle: it applies the style to the markdown text as you write it without modifying any text - that is, _all_ ~control~ _characters_ are always visible, simultaneously resolving cursor ambiguity and providing feedback on the final style.
